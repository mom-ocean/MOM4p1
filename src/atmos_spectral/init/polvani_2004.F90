...
'$Id: polvani_2004.F90,v 17.0 2009/07/21 03:00:37 fms Exp $'
...
if(num_levels /= 20) then
  call mpp_error(FATAL,'Number of vertical levels must be 20 when using polvani_2007 initialization')
endif
