...
module ocean_obc_mod
  ...
  ! <REVIEWER EMAIL="Stephen.Griffies@noaa.gov"> Stephen Griffies </REVIEWER>
...
!  [m s-1][s m-1] = [nd]             
  ...
  !#####################################################################
  !<SUBROUTINE NAME="ocean_obc_barotropic_dteta" INTERFACE="ocean_obc_barotropic">
...
! The output is written as snapshot or time mean
  ...
  !#######################################################################
  !<SUBROUTINE NAME="store_ocean_obc_tracer_advect">
