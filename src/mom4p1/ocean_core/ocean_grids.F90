...
! </NAMELIST>
!
use constants_mod,     only: pi, radian, radius, epsln, grav, c2dbars, deg_to_rad
...
use mpp_domains_mod,   only: mpp_global_sum, BITWISE_EXACT_SUM, CORNER, EAST, NORTH, XUPDATE
use mpp_domains_mod,   only: mpp_define_domains, mpp_get_domain_extents, mpp_deallocate_domain
use mpp_domains_mod,   only: mpp_get_compute_domain, mpp_get_data_domain, mpp_get_global_domain
use mpp_mod,           only: stdout, stdlog, mpp_error, mpp_chksum, mpp_sum, FATAL, NOTE, mpp_pe
...
character(len=128) :: version=&
     '$Id: ocean_grids.F90,v 16.0.2.1.48.1.4.1.4.1 2009/12/01 21:40:33 smg Exp $'
...
namelist /ocean_grids_nml/ debug_this_module, verbose_init, read_rho0_profile, write_grid
...
! </DESCRIPTION>
!
subroutine ocean_grids_init(debug, ver_coordinate, ver_coordinate_class)
...
subroutine set_ocean_hgrid_arrays(Domain, Grid)
 ...
 if(grid_version == VERSION_2) then
  ...
  call update_boundaries(Domain,Grid,Grid%dxt,0,0,0,0)
  ...
  call update_boundaries(Domain,Grid,Grid%dyt,0,0,0,0)
  ...
  call update_boundaries(Domain,Grid,Grid%dxu,-1,-1,0,0)
  ...
  call update_boundaries(Domain,Grid,Grid%dyu,-1,-1,0,0)
  ...
  call update_boundaries(Domain,Grid,Grid%dxtn,0,-1,0,0)
  ...
  call update_boundaries(Domain,Grid,Grid%dytn,0,-1,0,0)
  ...
  call update_boundaries(Domain,Grid,Grid%dxte,-1,0,0,0) 
  ...
  call update_boundaries(Domain,Grid,Grid%dyte,-1,0,0,0)
  ...
  call update_boundaries(Domain,Grid,Grid%dxun,-1,-2,0,0)
  ...
  call update_boundaries(Domain,Grid,Grid%dyun,-1,-2,0,0)
  ...
  call update_boundaries(Domain,Grid,Grid%dxue,-2,-1,0,0) 
  ...
  call update_boundaries(Domain,Grid,Grid%dyue,-2,-1,0,0) 
...
! </DESCRIPTION>
!
subroutine update_boundaries(Domain, Grid, field, i_offset, j_offset, ishift, jshift, field_ref)  
type(ocean_domain_type),                            intent(inout) :: Domain
