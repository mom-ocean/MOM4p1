...
!
! <NOTE>
! The numerical implementation in mom4p1 does not include the sink due 
...
use mpp_mod,          only: mpp_error, mpp_pe, mpp_max, mpp_sum, mpp_chksum
...
character(len=256) :: version=&
  '=>Using: ocean_bihcst_friction.f90 ($Id: ocean_bihcst_friction.F90,v 16.0.2.1.84.1 2009/10/10 00:42:15 nnz Exp $)'
