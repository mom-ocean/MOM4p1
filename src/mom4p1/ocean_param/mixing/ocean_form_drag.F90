...
use ocean_parameters_mod, only: rho0r, onehalf
...
character(len=128) :: version=&
       '$Id: ocean_form_drag.F90,v 16.0.2.1.84.1 2009/10/10 00:42:18 nnz Exp $'
...
subroutine ocean_form_drag_init(Grid, Domain, Time, Time_steps, Ocean_options, debug)
  ...
  id_form_drag_aiki_coeff= register_diag_field ('ocean_model', 'form_drag_aiki_coeff', &
                           ...
                           'dimensionless form drag coefficient for Aiki scheme',      &
