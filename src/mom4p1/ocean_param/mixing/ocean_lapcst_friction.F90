...
!
! <REFERENCE>
!  S.M. Griffies, Elements of mom4p1 (2005)
! </REFERENCE>
!
! <NOTE>
...
use mpp_mod,             only: mpp_sum, mpp_pe, mpp_max, mpp_error, mpp_chksum
...
character(len=256) :: version=&
     '=>Using: ocean_lapcst_friction.f90 ($Id: ocean_lapcst_friction.F90,v 16.0.2.1.84.1 2009/10/10 00:42:21 nnz Exp $)'
