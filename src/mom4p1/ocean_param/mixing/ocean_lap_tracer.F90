...
!  reason. 
!  </DATA> 
!  <DATA NAME="alapx1" UNITS="m^2/sec" TYPE="real">
...
character(len=128) :: version=&
     '$Id: ocean_lap_tracer.F90,v 16.0.2.1.86.1 2009/10/10 00:42:20 nnz Exp $'
...
subroutine lap_tracer (Time, Thickness, Tracer, ntracer, diag_flag)
  ...
  if (have_obc) call store_ocean_obc_tracer_flux(Time, Tracer,-1.0*fx, -1.0*fy, ntracer)
