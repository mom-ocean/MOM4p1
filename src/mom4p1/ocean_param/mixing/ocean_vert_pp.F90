...
use constants_mod,       only: grav, pi, epsln
...
character(len=128) :: version = &
     '$Id: ocean_vert_pp.F90,v 16.0.108.1 2009/10/10 00:42:37 nnz Exp $'
...
! </DESCRIPTION>
!
subroutine ocean_vert_pp_init (Grid, Domain, Time, Time_steps, T_prog)
...
! </DESCRIPTION>
!
  subroutine vert_mix_pp(Time, Thickness, Velocity, T_prog, Dens, visc_cbu, diff_cbt)
  ...
  call ri_for_pp (Time, Thickness, Velocity, T_prog(index_temp), T_prog(index_salt), &
                  Dens%pressure_at_depth, Dens%rho(:,:,:,taum1))
...
! </DESCRIPTION>
!
subroutine ri_for_pp (Time, Thickness, Velocity, Temp, Salt, pressure_at_depth, rho_taum1)
