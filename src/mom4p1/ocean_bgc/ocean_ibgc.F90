...
use mpp_mod,                  only: stdout, stdlog, mpp_error, mpp_sum, mpp_chksum, FATAL, NOTE
...
character(len=128) :: version = '$Id: ocean_ibgc.F90,v 1.1.4.2.20.1.2.2.12.2.14.1 2009/10/10 00:41:42 nnz Exp $'
