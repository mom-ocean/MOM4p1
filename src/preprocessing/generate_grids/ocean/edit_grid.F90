...
#include <netcdf.inc>
 ...
 !
  ...
  character(len=128) :: version = '$Id: edit_grid.F90,v 17.0 2009/07/21 03:22:35 fms Exp $'
...
contains
  ...
  subroutine read_orig_grid
    ...
    logical            :: ht_found, hu_found, dxte_found
    ...
    if (.not.hu_found)   call mpp_error(FATAL,'edit_grid: depth_c not found in the file '//trim(orig_grid) )    
