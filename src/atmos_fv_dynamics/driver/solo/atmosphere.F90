...
use fms_mod,          only: file_exist, open_namelist_file,   &
  ...
  use fms_mod,          only: nullify_domain
#endif 
...
character(len=128) :: version = '$Id: atmosphere.F90,v 17.0 2009/07/21 02:53:01 fms Exp $'
...
!       write(6,*) 'FV:', days, seconds
    ...
    if( nlev > 1 ) then 
         ...
         allocate ( rlatb2d(nlon+1,beglat:endlat+1) )
         allocate ( rlonb2d(nlon+1,beglat:endlat+1) )
