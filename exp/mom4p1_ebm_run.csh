#!/bin/csh -f
# Minimal runscript: mom4p1_ebm


set platform      = ia64           # A unique identifier for your platform
set name          = mom4p1_ebm1    # Name of the experiment you want to run
                                   # Currently "mom4p1_ebm1"

set npes          = 17             # number of processor
                                   # Note: If you change npes you may need to change
                                   # the layout in the corresponding namelist
set type          = mom4p1_ebm     # type of the experiment
...
set archive       = /archive/nnz/fms/mom4p1_pubrel_dec2009 #Large directory to host the input and output data.
...
#    else  
    ...
    echo "Please make sure that the variable 'name' in this script is set to one of ebm1."
