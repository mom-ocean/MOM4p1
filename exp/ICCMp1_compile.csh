#!/bin/csh -f
# Minimal compile script for fully coupled model ICCMp1 experiments

set echo
set platform      = ia64           # A unique identifier for your platform and compiler
...
#
set type          = ICCMp1                            # Name of the experiment
